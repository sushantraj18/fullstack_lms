...
function AdminTable() {
  return (
    <div>
        <div className="container w-full  p-2 mx-auto rounded-md sm:p-4 dark:text-gray-50 dark:bg-slate-950">
	<h2 className="mb-3 text-2xl font-semibold leading-tight">Standings</h2>
	<div className="overflow-x-auto">
		<table className="min-w-full text-xs">
			<thead className="rounded-t-lg dark:bg-gray-950">
			...
			<tbody>
				<tr className="text-right border-b border-opacity-20 dark:border-gray-300 dark:bg-gray-950">
